...
Complete JavaScript/Node.js code examples for using LunaProxy.
...
const options = {
  ...
  proxy: 'http://username:password@gateway.lunaproxy.com:22225'
};
...
const proxyConfig = {
  proxy: {
    ...
    port: 22225,
    auth: {
      username: process.env.LUNAPROXY_USER,
      password: process.env.LUNAPROXY_PASS
    }
  }
};
