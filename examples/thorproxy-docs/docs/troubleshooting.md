...
Common issues and solutions when using ThorProxy.
...
2. Verify proxy address: `gateway.thorproxy.com:22225`
...
try:
    response = requests.get(
        "https://api.ipify.org",
        proxies={"http": "http://user:pass@gateway.thorproxy.com:22225"},
        timeout=10
    )
...
```python
# Specify exact city
proxy = {"http": "http://user-city-jakarta:pass@gateway.thorproxy.com:22225"}
```
