...
Understanding ThorProxy performance characteristics and optimization strategies.
...
high_volume = {"http": "http://user-rotation:pass@gateway.thorproxy.com:22225"}

# Moderate scraping: timer-based
moderate = {"http": "http://user-session-5min:pass@gateway.thorproxy.com:22225"}

# Session-based: sticky sessions
sessions = {"http": "http://user-sticky-30min:pass@gateway.thorproxy.com:22225"}
```
