...
```python
# 1 minute
proxy_1min = "http://user-session-1min:password@gateway.thorproxy.com:22225"

# 5 minutes
proxy_5min = "http://user-session-5min:password@gateway.thorproxy.com:22225"

# 10 minutes
proxy_10min = "http://user-session-10min:password@gateway.thorproxy.com:22225"
```
