...
proxy = {"http": "http://user-rotation:password@gateway.thorproxy.com:22225"}
...
pool = ProxyPool([
    {"http": "http://user-rotation:pass@gateway.thorproxy.com:22225"},
    {"http": "http://user-session-5min:pass@gateway.thorproxy.com:22225"},
    {"http": "http://user-sticky-30min:pass@gateway.thorproxy.com:22225"}
])
