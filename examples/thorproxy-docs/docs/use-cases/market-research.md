...
Monitor competitor prices and analyze market trends across different regions using ThorProxy.
...
# Jakarta prices
jakarta_proxy = {
    "http": "http://user-city-jakarta:password@gateway.thorproxy.com:22225"
}

# Surabaya prices  
surabaya_proxy = {
    "http": "http://user-city-surabaya:password@gateway.thorproxy.com:22225"
}
