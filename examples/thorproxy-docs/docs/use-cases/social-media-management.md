...
account_1_proxy = {
    "http": "http://user-static-1:password@gateway.thorproxy.com:22225"
}

account_2_proxy = {
    "http": "http://user-static-2:password@gateway.thorproxy.com:22225"
}
...
id_proxy = {
    "http": "http://user-country-id-isp-telkomsel:password@gateway.thorproxy.com:22225"
}

# US business account uses US IP
us_proxy = {
    "http": "http://user-country-us-isp-comcast:password@gateway.thorproxy.com:22225"
}
```
